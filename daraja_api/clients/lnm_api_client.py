import abc, json, datetime, base64, requests
...
class LNMApiClient(AbstractLNMApiClient):
    ...
    def stk_push(self, phone_number:str, amount:int, account_reference:str,
        transaction_desc:str, callback_url:str):
        ...
        _ p = (business_short_code + passkey + timestamp).encode()
        ...
        headers = {
            'Authorization': 'Bearer ' + generate_token(self.config),
